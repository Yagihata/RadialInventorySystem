...
namespace YagihataItems.RadialInventorySystemV4
{
    public abstract class EditorTab
    {
        ...
        public abstract void BuildExpressionParameters(ref Avatar risAvatar, string autoGeneratedFolder);
        public abstract void BuildExpressionsMenu(ref Avatar risAvatar, string autoGeneratedFolder);
        ...
        protected void CheckParam(VRCAvatarDescriptor avatar, AnimatorController controller, Parameter parameter)
        {
            var type = UnityEngine.AnimatorControllerParameterType.Float;
            if (parameter.ValueType == VRCExpressionParameters.ValueType.Int)
                ...
                type = UnityEngine.AnimatorControllerParameterType.Bool;

            var param = controller.parameters.FirstOrDefault(n => n.name == parameter.Name);
            if (param == null)
            {
                controller.AddParameter(parameter.Name, type);
                param = controller.parameters.FirstOrDefault(n => n.name == parameter.Name);
            }
            param.type = type;
        }
